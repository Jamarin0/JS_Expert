...
//internamente, obj literais viram funções explicitas
...
// quando chamarmos o new o __proto__ recebe o prototype
console.log('manager.__proto__: %$, manager.salary(): %$',new Manager().__proto__, new Manager().salary())
